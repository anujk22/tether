  ...
  return (
    <div className="station-scene" aria-label="Tether orbital control station">
      ...
      <svg className="orbit-map" viewBox="0 0 820 520" aria-hidden="true">
        <path d="M94 112 C130 78 178 82 208 116 C246 160 244 204 208 224 C178 242 150 226 168 202 C194 166 258 180 310 218" />
        <path d="M118 128 C116 168 150 180 158 214 C168 256 136 282 168 306 C198 328 232 286 222 248" />
        <path d="M318 72 C430 28 598 36 670 88 C732 134 722 180 660 198 C610 214 568 190 596 160 C632 122 706 142 784 206" />
